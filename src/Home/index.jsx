  ...
  return (
    <div className="border-b border-silver p-4 space-y-6">
      <div className="flex space-x-5">
        <img src="\src\Home\avatar.png" className="w-7" />
...
export function Home({ loggedInUser }) {
  ...
  return (
    <>
      ...
      <div>
        <Tweet name="Elon Musk" username="elonmusk" avatar="\src\Home\avatar.png">
          Lets Make Twitter Maximun Fun!
        </Tweet>

        {data.length && data.map(tweet => (
          <Tweet key={tweet.id} name={tweet.user.name} username={tweet.user.username} avatar="\src\Home\avatar.png">
            {tweet.text}
          </Tweet>
        ))}
